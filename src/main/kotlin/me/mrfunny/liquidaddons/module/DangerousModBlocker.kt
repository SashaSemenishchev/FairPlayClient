...
@ModuleInfo("Dangerous Mod Blocker", "Prevents enabling of dangerous mods", ModuleCategory.MISC, Keyboard.KEY_BACKSLASH)
object DangerousModBlocker : Module() {
    @JvmStatic
    fun isBad(module: Module): Boolean {
        ...
        for (dangerousMod in dangerousMods) {
    ...
    private val dangerousMods: List<Class<out Module>> = listOf(
        Fly::class.java,
        KillAura::class.java,
        Ignite::class.java,
        FastBow::class.java,
    ...
    val allowedRenderMods: List<Class<out Module>> = listOf(
